...
-(UIView *)actionToolBar{
    ...
    [ok setTitleColor:RS_Theme_Color forState:UIControlStateNormal];
    [ok setTitleColor:RS_Theme_Color forState:UIControlStateHighlighted];
