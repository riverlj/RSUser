...
#define APP_REGISTER_URL @"http://waimai.dev.honglingjinclub.com/web/register.html"
#define APP_RESETPWD_URL @"http://waimai.dev.honglingjinclub.com/web/resetPwd.html"
#endif
